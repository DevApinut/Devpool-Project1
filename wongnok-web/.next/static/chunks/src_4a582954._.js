...
"[project]/src/app/edit-recipe/[recipeId]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const RecipeSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].object({
    ...
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(2, {
        message: 'กรุณากรอกอย่างน้อย 10 ตัวอักษร'
    }),
    ingredient: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(2, {
        message: 'กรุณาใส่วัตถุดิบที่ต้องการ'
    }),
    instruction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().min(2, {
        message: 'กรุณาใส่วิธีการ'
    }),
    imageURL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string().url().optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].literal('')),
    difficulty: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].enum([
        '1',
        '2',
        '3'
    ]),
    duration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].enum([
        '1',
        '2',
        '3',
        '4'
...
const EditRecipe = (param)=>{
    ...
    const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "EditRecipe.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRecipeDetails"])(Number(recipeId))
        }["EditRecipe.useQuery"]
    });
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "EditRecipe.useEffect": ()=>{
            if (data === null || data === void 0 ? void 0 : data.data) {
                var _data_data_difficulty, _data_data_cookingDuration;
                var _data_data_name, _data_data_description, _data_data_ingredient, _data_data_instruction, _data_data_imageUrl;
                form.reset({
                    name: (_data_data_name = data.data.name) !== null && _data_data_name !== void 0 ? _data_data_name : '',
                    description: (_data_data_description = data.data.description) !== null && _data_data_description !== void 0 ? _data_data_description : '',
                    ingredient: (_data_data_ingredient = data.data.ingredient) !== null && _data_data_ingredient !== void 0 ? _data_data_ingredient : '',
                    instruction: (_data_data_instruction = data.data.instruction) !== null && _data_data_instruction !== void 0 ? _data_data_instruction : '',
                    imageURL: (_data_data_imageUrl = data.data.imageUrl) !== null && _data_data_imageUrl !== void 0 ? _data_data_imageUrl : '',
                    difficulty: [
                        '1',
                        '2',
                        '3'
                    ].includes(String((_data_data_difficulty = data.data.difficulty) === null || _data_data_difficulty === void 0 ? void 0 : _data_data_difficulty.id)) ? String(data.data.difficulty.id) : '1',
                    duration: [
                        '1',
                        '2',
                        '3',
                        '4'
                    ].includes(String((_data_data_cookingDuration = data.data.cookingDuration) === null || _data_data_cookingDuration === void 0 ? void 0 : _data_data_cookingDuration.id)) ? String(data.data.cookingDuration.id) : '1'
                });
            }
        }
    }["EditRecipe.useEffect"], [
    ...
    const { mutateAsync: UpdateRecipe } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateMyRecipe"],
        onError: {
            "EditRecipe.useMutation": ()=>{
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])(RecipeSchema),
        defaultValues: {
            name: '',
            description: '',
            ingredient: '',
...
_s(EditRecipe, "79bcnBRQqK/up3cAp+SFg62T/ak=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "EditRecipe");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_4a582954._.js.map