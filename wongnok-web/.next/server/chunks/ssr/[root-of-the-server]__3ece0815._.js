...
const EditRecipe = ({ params })=>{
        ...
        if (data?.data) {
            form.reset({
                ...
                difficulty: [
                    ...
                    '2',
                    '3'
                ].includes(String(data.data.difficulty?.id)) ? String(data.data.difficulty.id) : '1',
                duration: [
                    '1',
                    '2',
                    '3',
                    '4'
                ].includes(String(data.data.cookingDuration?.id)) ? String(data.data.cookingDuration.id) : '1'
            });
        }
    }, [
        data
    ]);
    const { mutateAsync: UpdateRecipe } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$recipe$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateMyRecipe"],
        onError: ()=>{
    ...
    if (isLoading || status === 'loading') return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/edit-recipe/[recipeId]/page.tsx",
        lineNumber: 105,
        columnNumber: 49
    }, ("TURBOPACK compile-time value", void 0));
...
const __TURBOPACK__default__export__ = EditRecipe;
}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__3ece0815._.js.map